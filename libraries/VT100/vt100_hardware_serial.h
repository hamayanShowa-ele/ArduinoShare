/**
  ...
  */
#ifndef  __vt100_hardware_serial_h__
#define  __vt100_hardware_serial_h__
...
class VT100_HARDWARE_SERIAL : public VT100
{
private:
...
public:
  VT100_HARDWARE_SERIAL() { serial = nullptr; }
  VT100_HARDWARE_SERIAL( HardwareSerial *s ) { config( s ); }

  void config( HardwareSerial *s ) { serial = s; }
...
};  /* VT100_HARDWARE_SERIAL */

#endif  /* __vt100_hardware_serial_h__ */
